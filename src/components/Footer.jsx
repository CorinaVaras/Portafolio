  ...
  return (
    <div className="container-footer" id="footer">
      <div className="social-networks">
        <a
          href="https://drive.google.com/file/d/1DnYXG4MtyEj_hN39twaOanb-kzqPWt8V/view?usp=sharing"
          target="_blank"
          title="CV"
        ...
        <a
          href="https://www.linkedin.com/in/corinavaras/"
          target="_blank"
        ...
        <a
          href="mailto:corinacvp@gmail.com"
          target="_blank"
      ...
      <small>Copyright ©2020 by Corina Varas</small>
    </div>
  );
};
